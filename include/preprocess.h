...
//   EIGEN_MAKE_ALIGNED_OPERATOR_NEW
  ...
  void process(const livox_interface::msg::CustomMsg::UniquePtr &msg, PointCloudXYZI::Ptr &pcl_out);
...
private:
  void avia_handler(const livox_interface::msg::CustomMsg::UniquePtr &msg);
